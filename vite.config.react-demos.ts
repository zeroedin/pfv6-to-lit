...
function findReactDemos() {
  ...
  for (const [componentName, componentData] of Object.entries(manifest.components)) {
    ...
    for (const fileName of Object.values(componentData.demos)) {
...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      {
        find: '../../PF-IconLogo.svg',
        replacement: resolve('dev-server/assets/patternfly/assets/images/PF-IconLogo.svg'),
      },

      // Specific logo file imports (with assets/ prefix)
      {
        find: '../../assets/PF-IconLogo.svg',
        replacement: resolve('dev-server/assets/patternfly/assets/images/PF-IconLogo.svg'),
      },
      {
        find: '../../assets/PF-IconLogo-color.svg',
        replacement: resolve('dev-server/assets/patternfly/assets/images/PF-IconLogo-color.svg'),
      },
      {
        find: '../../assets/PF-IconLogo-Reverse.svg',
        replacement: resolve('dev-server/assets/patternfly/assets/images/PF-IconLogo-Reverse.svg'),
      },

      // Generic assets folder imports (regex captures filename)
      {
        find: /^\.\.\/\.\.\/assets\/(.*)$/,
        replacement: resolve('dev-server/assets/patternfly/assets/images/$1'),
      },
    ],
  },
  ...
  experimental: {
    renderBuiltUrl(_filename, { hostType: _hostType }) {
