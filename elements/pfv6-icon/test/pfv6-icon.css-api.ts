...
const cssApiTests = [
  ...
  // Body sizes - sm
  {
    ...
    defaultValue: 'var(--pf-t--global--icon--size--font--body--sm, 0.75rem)',
    resolvedValue: '0.75rem',
    type: 'size',
    testValue: '50rem',
  ...
  // Body sizes - lg
  {
    ...
    defaultValue: 'var(--pf-t--global--icon--size--font--body--lg, 1rem)',
    resolvedValue: '1rem',
    type: 'size',
    testValue: '50rem',
    demo: 'body-icon-sizes'
  ...
  // Heading sizes - sm
  {
    ...
    defaultValue: 'var(--pf-t--global--icon--size--font--heading--h6, 1rem)',
    resolvedValue: '1rem',
    type: 'size',
    testValue: '50rem',
  ...
  // Heading sizes - md
  {
    ...
    defaultValue: 'var(--pf-t--global--icon--size--font--heading--h5, 1rem)',
    resolvedValue: '1rem',
    type: 'size',
    testValue: '50rem',
    demo: 'heading-icon-sizes'
  ...
  // Heading sizes - lg
  {
    ...
    defaultValue: 'var(--pf-t--global--icon--size--font--heading--h4, 1rem)',
    resolvedValue: '1rem',
    type: 'size',
    testValue: '50rem',
    demo: 'heading-icon-sizes'
  ...
  // Heading sizes - xl
  {
    ...
    defaultValue: 'var(--pf-t--global--icon--size--font--heading--h3, 1.125rem)',
  ...
  // Heading sizes - 2xl
  {
    ...
    defaultValue: 'var(--pf-t--global--icon--size--font--heading--h2, 1.25rem)',
  ...
  // Heading sizes - 3xl
  {
    ...
    defaultValue: 'var(--pf-t--global--icon--size--font--heading--h1, 1.5rem)',
    resolvedValue: '1.5rem',
    type: 'size',
    testValue: '50rem',
    demo: 'heading-icon-sizes'
  ...
  // Progress state - content opacity
  {
  ...
  // Progress state - progress opacity
  {
