...
/**
 * CSS API Tests for pfv6-text-area
 *
...
const cssApiTests = [
  ...
  },
  {
    ...
    defaultValue: 'var(--pf-v6-c-form-control--PaddingBlockStart--base)',
    resolvedValue: '0.5rem',
    type: 'size',
    testValue: '50px',
    demo: 'basic'
  },
  {
    ...
    defaultValue: 'var(--pf-v6-c-form-control--PaddingBlockEnd--base)',
    resolvedValue: '0.5rem',
    type: 'size',
    testValue: '50px',
    demo: 'basic'
  },
  {
    ...
    defaultValue: 'var(--pf-v6-c-form-control--PaddingInlineEnd--base)',
    resolvedValue: '1rem',
    type: 'size',
    testValue: '50px',
    demo: 'basic'
  },
  {
    ...
    defaultValue: 'var(--pf-v6-c-form-control--PaddingInlineStart--base)',
    resolvedValue: '1rem',
    type: 'size',
    testValue: '50px',
    demo: 'basic'
  ...
  // Textarea padding
  {
    name: '--pf-v6-c-form-control__textarea--PaddingBlockStart',
    defaultValue: 'var(--pf-v6-c-form-control--PaddingBlockStart--base)',
    resolvedValue: '0.5rem',
    type: 'size',
    testValue: '50px',
  ...
  {
    name: '--pf-v6-c-form-control__textarea--PaddingBlockEnd',
    defaultValue: 'var(--pf-v6-c-form-control--PaddingBlockEnd--base)',
    resolvedValue: '0.5rem',
    type: 'size',
    testValue: '50px',
  ...
  {
    name: '--pf-v6-c-form-control__textarea--PaddingInlineEnd',
    defaultValue: 'var(--pf-v6-c-form-control--PaddingInlineEnd--base)',
    resolvedValue: '1rem',
    type: 'size',
    testValue: '50px',
  ...
  {
    name: '--pf-v6-c-form-control__textarea--PaddingInlineStart',
    defaultValue: 'var(--pf-v6-c-form-control--PaddingInlineStart--base)',
    resolvedValue: '1rem',
    type: 'size',
    testValue: '50px',
  ...
  },
  {
    ...
    defaultValue: 'var(--pf-t--global--border--color--status--success--hover, #afdc8f)',
    resolvedValue: '#afdc8f',
    type: 'color',
    testValue: 'rgb(255, 0, 0)',
    demo: 'basic'
  },
  ...
  },
  {
    ...
    defaultValue: 'var(--pf-t--global--border--color--status--danger--hover, #fbbea8)',
  ...
  // Disabled states
  {
    ...
    defaultValue: 'var(--pf-t--global--text--color--on-disabled, #707070)',
  ...
  },
  {
    ...
    defaultValue: 'var(--pf-t--global--border--color--status--warning--default, #f8ae54)',
    resolvedValue: '#f8ae54',
    type: 'color',
    testValue: 'rgb(255, 0, 0)',
    demo: 'basic'
  },
  ...
  // Textarea specific
  {
    ...
    defaultValue: 'var(--pf-v6-c-form-control--Width)',
    resolvedValue: '100%',
    type: 'size',
    testValue: '50%',
    demo: 'basic'
  ...
  },
  {
    ...
    defaultValue: 'var(--pf-t--global--icon--color--status--warning--default, #f8ae54)',
    resolvedValue: '#f8ae54',
    type: 'color',
    testValue: 'rgb(255, 0, 0)',
    demo: 'basic'
  ...
  },
  {
    ...
    defaultValue: 'var(--pf-v6-c-form-control--PaddingBlockStart)',
    resolvedValue: '0.5rem',
    type: 'size',
    testValue: '50px',
    demo: 'basic'
  ...
  // Resize modes
  {
    name: '--pf-v6-c-form-control--m-resize-vertical--resize',
    defaultValue: 'vertical',
    resolvedValue: 'vertical',
    type: 'keyword',
    testValue: 'both',
    demo: 'vertically-resizable'
  },
  {
    name: '--pf-v6-c-form-control--m-resize-horizontal--resize',
    defaultValue: 'horizontal',
    resolvedValue: 'horizontal',
    type: 'keyword',
    testValue: 'both',
    demo: 'horizontally-resizable'
  },
  {
    name: '--pf-v6-c-form-control--m-resize-both--resize',
    defaultValue: 'both',
    resolvedValue: 'both',
    type: 'keyword',
    testValue: 'none',
  ...
  cssApiTests.forEach(({ name, defaultValue, resolvedValue, type, testValue, demo }) => {
    test(`CSS API: ${name}`, async ({ page, browser }) => {
      ...
      try {
        ...
        await reactPage.goto(`/elements/pfv6-text-area/react/test/${demo}`);
        await applyCssOverride(reactPage, '.pf-v6-c-form-control', name, testValue);
        await waitForFullLoad(reactPage);

        // Load Lit demo with CSS override
        await page.goto(`/elements/pfv6-text-area/test/${demo}`);
        await applyCssOverride(page, 'pfv6-text-area', name, testValue);
