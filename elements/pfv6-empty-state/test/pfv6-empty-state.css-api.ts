...
const cssApiTests = [
  ...
  // Status variant icon colors
  {
    ...
    defaultValue:
      'var(--pf-t--global--icon--color--status--danger--default, #b1380b)',
  ...
  },
  {
    ...
    defaultValue:
      'var(--pf-t--global--icon--color--status--warning--default, #ffcc17)',
  ...
  },
  {
    ...
    defaultValue:
      'var(--pf-t--global--icon--color--status--success--default, #3d7317)',
  ...
  },
  {
    ...
    defaultValue:
      'var(--pf-t--global--icon--color--status--info--default, #5e40be)',
  ...
  },
  {
    ...
    defaultValue:
      'var(--pf-t--global--icon--color--status--custom--default, #147878)',
  ...
  // Title text variables
  {
    ...
    defaultValue:
      'var(--pf-t--global--font--family--heading, "Red Hat Display", Helvetica, Arial, sans-serif)',
    resolvedValue:
      '"Red Hat Display", "RedHatDisplay", "Noto Sans Arabic", '
      + '"Noto Sans Hebrew", "Noto Sans JP", "Noto Sans KR", '
      + '"Noto Sans Malayalam", "Noto Sans SC", "Noto Sans TC", '
  ...
  // Footer variables
  {
    ...
    defaultValue:
      'var(--pf-t--global--spacer--gap--group-to-group--vertical--default, 1.5rem)',
    resolvedValue: '1.5rem',
    type: 'size',
    testValue: '50px',
    demo: 'basic',
  ...
  },
  {
    ...
    defaultValue:
      'var(--pf-t--global--spacer--gap--action-to-action--default, 1rem)',
    resolvedValue: '1rem',
    type: 'size',
    testValue: '50px',
    demo: 'basic',
