...
const cssApiTests = [
  ...
  // Padding - input-specific
  {
    name: '--pf-v6-c-form-control__input--PaddingBlockStart',
  ...
  {
    name: '--pf-v6-c-form-control__input--PaddingBlockEnd',
  ...
  {
    name: '--pf-v6-c-form-control__input--PaddingInlineEnd',
  ...
  {
    name: '--pf-v6-c-form-control__input--PaddingInlineStart',
  ...
  // Placeholder
  {
    ...
    defaultValue: 'var(--pf-t--global--text--color--placeholder, #6a6e73)',
    resolvedValue: '#6a6e73',
    type: 'color',
    testValue: 'rgb(255, 0, 0)',
    demo: 'basic'
  },
  ...
  // Disabled state
  {
    ...
    defaultValue: 'var(--pf-t--global--text--color--on-disabled, #6a6e73)',
    resolvedValue: '#6a6e73',
    type: 'color',
    testValue: 'rgb(255, 0, 0)',
    demo: 'disabled'
  },
  {
    ...
    defaultValue: 'var(--pf-t--global--background--color--disabled--default, #f0f0f0)',
  ...
  // Readonly state
  {
    ...
    defaultValue: 'var(--pf-t--global--background--color--control--read-only, #f0f0f0)',
    resolvedValue: '#f0f0f0',
    type: 'color',
    testValue: 'rgb(255, 0, 0)',
    demo: 'read-only'
  },
  {
    ...
    defaultValue: 'var(--pf-t--global--border--color--control--read-only, #c7c7c7)',
    resolvedValue: '#c7c7c7',
    type: 'color',
    testValue: 'rgb(255, 0, 0)',
    demo: 'read-only'
  ...
  cssApiTests.forEach(({ name, defaultValue, resolvedValue, type, testValue, demo }) => {
    test(`CSS API: ${name}`, async ({ page, browser }) => {
      ...
      try {
        ...
        await reactPage.goto(`/elements/pfv6-text-input/react/demo/${demo}`);
        await applyCssOverride(reactPage, '.pf-v6-c-form-control', name, testValue);
        await waitForFullLoad(reactPage);

        // Load Lit demo with CSS override
        await page.goto(`/elements/pfv6-text-input/demo/${demo}`);
