...
/**
 * CSS API Tests for pfv6-form-select
 *
...
const cssApiTests = [
  ...
  },
  {
    ...
    defaultValue: 'var(--pf-v6-c-form-control--BorderRadius)',
    resolvedValue: '6px',
    type: 'size',
    testValue: '50px',
    demo: 'basic',
  ...
  {
    name: '--pf-v6-c-form-control--PaddingInlineEnd--base',
    defaultValue: 'var(--pf-v6-c-form-control--inset--base)',
    resolvedValue: '1rem',
    type: 'size',
    testValue: '50px',
    demo: 'basic',
  ...
  {
    name: '--pf-v6-c-form-control--PaddingInlineStart--base',
    defaultValue: 'var(--pf-v6-c-form-control--inset--base)',
    resolvedValue: '1rem',
    type: 'size',
    testValue: '50px',
  ...
  // Select-specific padding
  {
    name: '--pf-v6-c-form-control__select--PaddingBlockStart',
    defaultValue: 'var(--pf-v6-c-form-control--PaddingBlockStart--base)',
    resolvedValue: '0.5rem',
    type: 'size',
    testValue: '50px',
  ...
  {
    name: '--pf-v6-c-form-control__select--PaddingBlockEnd',
    defaultValue: 'var(--pf-v6-c-form-control--PaddingBlockEnd--base)',
    resolvedValue: '0.5rem',
    type: 'size',
    testValue: '50px',
  ...
  // Hover state - status variants
  {
    name: '--pf-v6-c-form-control--m-success--hover--after--BorderColor',
    defaultValue: 'var(--pf-t--global--border--color--status--success--hover, #204d00)',
    resolvedValue: '#204d00',
    type: 'color',
    testValue: 'rgb(255, 0, 0)',
    demo: 'basic',
  },
  {
    ...
    defaultValue: 'var(--pf-t--global--border--color--status--warning--hover, #b98412)',
    resolvedValue: '#b98412',
    type: 'color',
    testValue: 'rgb(255, 0, 0)',
    demo: 'basic',
  },
  {
    ...
    defaultValue: 'var(--pf-t--global--border--color--status--danger--hover, #731f00)',
  ...
  {
    name: '--pf-v6-c-form-control__toggle-icon--FontSize',
    defaultValue: 'var(--pf-t--global--icon--size--font--body--default, 0.875rem)',
    resolvedValue: '0.875rem',
    type: 'size',
    testValue: '50px',
  ...
  cssApiTests.forEach(({ name, defaultValue, resolvedValue, type, testValue, demo }) => {
    test(`CSS API: ${name}`, async ({ page, browser }) => {
      ...
      try {
        ...
        await reactPage.goto(`/elements/pfv6-form-select/react/test/${demo}`);
        await applyCssOverride(reactPage, '.pf-v6-c-form-control', name, testValue);
        await waitForFullLoad(reactPage);

        // Load Lit demo with CSS override
        await page.goto(`/elements/pfv6-form-select/test/${demo}`);
        await applyCssOverride(page, 'pfv6-form-select', name, testValue);
